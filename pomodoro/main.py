...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.title("Pomodoro Timer Mudhya")
        ...
        self.pomodoro_counter_label = ttk.Label(
            self.grid_layout, text="Pomodoro : 0", font=("Ubuntu", 16))
    ...
    def start_timer(self):
        ...
        if timer_id == 1:
            ...
            while full_seconds > 0 and not self.stopped:
                minutes, secondes = divmod(full_seconds, 60)
    ...
    def reset_clock(self):
        ...
        self.long_break_timer_label.configure(text="15:00")
        self.pomodoro_counter_label.configure(text="Pomodoros : 0")
        self.runnnging = False
